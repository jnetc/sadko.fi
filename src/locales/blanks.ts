export const locale_blank = {
  ru: {
    ...
    child_textarea_title: 'Заполните поле, если ребенок имеет инвалидность или какие-то проблемы со здоровьем. Либо поставте знак прочерк, минус (-), что ребенок здоров.',
    ...
    child_textarea_title: 'Täytä ruutu, jos lapsella on vamma tai terveysongelmia. Merkitse joko viiva tai miinusmerkki (-) merkiksi siitä, että lapsi on terve.',
