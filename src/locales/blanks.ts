export const locale_blank = {
  ru: {
    ...
    parent_phone_label: 'Телефона | Puhelinnumero',
    ...
    accept_rules: 'Я ознакомлен(а) и согласен(а) с | Olen lukenut ja hyväksynyt',
    ...
    date: 'Päivämäärä tai Viikonpäivä',
    time: 'Aika tai Kesto',
    child_legend: 'Lapsi',
