export const locale_blank = {
  ru: {
    ...
    parent_textarea_title: 'Поставте знак прочерк, минус (-), если не требуется дополнительная информация',
    ...
    parent_textarea_title: 'Jos ei tarvitsa lisätietoa, anna tyhjä merkki, miinus (-)',
